...
const SSR_PATHS: Record<string, string> = {
  ...
  zigzag: "M0,0 L120,60 L240,0 L360,60 L480,0 L600,60 L720,0 L840,60 L960,0 L1080,60 L1200,0 L1320,60 L1440,0 L1440,120 L0,120 Z",
  dots: "M0,40 Q360,0 720,40 Q1080,80 1440,40 L1440,120 L0,120 Z",
  ...
  diamond: "M0,40 L120,0 L240,40 L360,0 L480,40 L600,0 L720,40 L840,0 L960,40 L1080,0 L1200,40 L1320,0 L1440,40 L1440,120 L0,120 Z",
  ...
  pulse: "M0,40 L200,40 L280,0 L360,80 L440,0 L520,80 L600,0 L680,40 L880,40 C1040,40 1040,40 1200,40 L1440,40 L1440,120 L0,120 Z",
...
export default function SectionDivider({ ...a }: SectionDividerProp) {
  ...
  useEffect(() => {
    ...
    if (svgRef.current) controller.init(svgRef.current);
