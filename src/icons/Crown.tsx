...
export default function Crown({ size = 24, color = "currentColor", className, fill = false, fillColor }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <circle cx="6" cy="7" r="1" fill={fillColor || color} />
      <circle cx="12" cy="5" r="1" fill={fillColor || color} />
      <circle cx="18" cy="7" r="1" fill={fillColor || color} />
    </svg>
  );
}
