...
export default function Baby({ size = 24, color = "currentColor", className, fill = false, fillColor }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <circle cx="9" cy="7.5" r="0.75" fill={fillColor || color} />
      <circle cx="15" cy="7.5" r="0.75" fill={fillColor || color} />
    </svg>
  );
}
