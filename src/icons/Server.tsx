...
export default function Server({ size = 24, color = "currentColor", className, fill = false, fillColor }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <circle cx="6" cy="6" r="1" fill={fillColor || color} />
      <circle cx="6" cy="18" r="1" fill={fillColor || color} />
