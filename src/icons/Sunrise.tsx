...
export default function Sunrise({ size = 24, color = "currentColor", className, fill: _fill = false, fillColor: _fillColor }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M12 2v7" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
